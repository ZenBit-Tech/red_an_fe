...
- [ ] no links in the code, env links should be in env file (for example: server url),
...
- [ ] No hardcoded values
- [ ] covered by tests
- [ ] Check your commit messages meet the [conventional commit format](htt
      ps://www.conventionalcommits.org/en/v1.0.0/).

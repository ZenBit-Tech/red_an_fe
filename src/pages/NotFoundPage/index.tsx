...
import { NOT_FOUND_ASTRONAUT_URL, NOT_FOUND_BG_URL } from "./constants";
...
export const NotFoundPage = () => {
  ...
  return (
    <S.PageWrapper>
      <S.BackgroundImage src={NOT_FOUND_BG_URL} alt="" />
      ...
      <S.AstronautImage src={NOT_FOUND_ASTRONAUT_URL} alt="" />
